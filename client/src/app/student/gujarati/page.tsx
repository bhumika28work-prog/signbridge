        ...
        <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-amber-400">Learn Gujarati with Indian Sign Language</p>
                </motion.div>
                    ...
                    <div className="glass rounded-2xl p-2 inline-flex gap-2 flex-wrap">
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-xl font-semibold transition-all ${activeTab === 'lessons'
                                    ? 'bg-gradient-to-r from-cyan- to-teal- text-stone-100 shadow-lg'
                        ...
                        <div className="lg:col-span-2">
                            <div className="glass rounded-3xl p-8">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-cyan- to-teal- text-stone-100 font-semibold rounded-xl hover:shadow-lg transition-all mb-6"
                                >
                                ...
                                {/* Practice Section */}
                                <div className="mt-8 p-6 bg-stone-800 rounded-2xl">
                                    <h3 className="text-xl font-bold mb-4 text-amber-900">Practice Writing</h3>
                                    <div className="bg-stone-800 rounded-xl p-8 border-2 border-dashed border-amber-300">
                                        <p className="text-center text-7xl font-bold text-stone-300 select-none">
                                ...
                                <div className="flex justify-between mt-8">
                                    ...
                                    <button
                                        ...
                                        className="px-6 py-3 bg-gradient-to-r from-cyan- to-teal- text-stone-100 font-semibold rounded-xl hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        Next
                                    </button>
                                </div>
                ...
                {activeTab === 'alphabet' && (
                    <div className="glass rounded-3xl p-8">
                        ...
                        <p className="text-amber-400 mb-6">Click any character to see its ISL sign</p>

                        <h3 className="text-xl font-bold mb-4 text-stone-100">Vowels (સ્વરો)</h3>
                        ...
                        <h3 className="text-xl font-bold mb-4 text-stone-100">Consonants (વ્યંજનો)</h3>
                        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-12 gap-4 mb-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        <div className="glass rounded-3xl p-8">
                            ...
                            <textarea
                                ...
                                className="w-full h-40 px-4 py-3 rounded-xl border-2 border-amber-500/30 focus:border-cyan- focus:ring-4 focus:ring-cyan- transition-all resize-none mb-4"
                            />
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {['નમસ્તે', 'આભાર', 'શુભ પ્રભાત', 'તમે કેમ છો?', 'મારું નામ'].map((phrase) => (
                                        <button
                                            ...
                                            className="px-4 py-2 bg-stone-800 rounded-lg text-sm font-medium text-stone-300 hover:bg-gradient-to-r hover:from-cyan- hover:to-teal- hover:text-stone-100 transition-all"
                                        >
                                            {phrase}
                                        </button>
                                    ))}
                        ...
                        <div className="glass rounded-3xl p-8">
                            ...
                            {inputText ? (
                                ...
                                <div className="h-40 flex items-center justify-center bg-gradient-to-br from-cyan- to-teal- rounded-xl">
                                    <p className="text-stone-400">Type Gujarati text to see ISL signs</p>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="glass rounded-3xl p-8">
                            ...
                            <div className="h-40 flex items-center justify-center bg-gradient-to-br from-cyan- to-teal- rounded-xl mb-4">
                                <button
                                    ...
                                    className={`p-8 rounded-full transition-all duration-300 ${isListening
                                            ...
                                            : 'bg-stone-800 text-cyan- hover:scale-110'
                                        } shadow-xl`}
                                >
                            ...
                            <button
                                ...
                                className={`w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl font-semibold transition-all ${isListening
                                        ...
                                        : 'bg-gradient-to-r from-cyan- to-teal- text-stone-100 hover:shadow-lg hover:scale-105'
                                    }`}
                            >
