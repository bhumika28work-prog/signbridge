                    ...
                    >
                        ...
                        <div className="grid gap-4">
                            ...
                            <button
                                ...
                                className="px-8 py-6 bg-gradient-to-r from-yellow-500 to-orange-500 text-slate-100 font-bold text-xl rounded-2xl hover:shadow-xl transition-all hover:scale-105"
                            >
                                Medium (8 Pairs)
                            </button>
                            <button
