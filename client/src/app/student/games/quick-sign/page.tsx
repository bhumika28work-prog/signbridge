        ...
        <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-amber-400">Identify signs as fast as you can!</p>
                </motion.div>
                ...
                {!gameStarted && (
                    ...
                    >
                        ...
                        <button
                            onClick={startGame}
                            className="px-12 py-4 bg-gradient-to-r from-orange-500 to-red-500 text-stone-100 font-bold text-xl rounded-2xl hover:shadow-xl transition-all hover:scale-105 animate-pulse"
                        >
                            Start Quick Sign!
                        </button>
                    </motion.div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            <div className="glass rounded-xl p-4 text-center">
                                ...
                                <p className={`text-3xl font-bold ${timeLeft <= 1 ? 'text-red-500 animate-pulse' : 'text-stone-100'}`}>
                                    {timeLeft}s
                                </p>
                            </div>
                            <div className="glass rounded-xl p-4 text-center">
                            ...
                            <div className="glass rounded-xl p-4 text-center">
                                ...
                                <p className="text-2xl font-bold text-stone-100">{combo}x</p>
                            </div>
                            <div className="glass rounded-xl p-4 text-center">
                                <Zap className="w-6 h-6 mx-auto mb-2 text-cyan-" />
                                <p className="text-2xl font-bold text-stone-100">{round + 1}/{totalRounds}</p>
                            </div>
                        </div>
                    ...
                    {gameOver && (
                        ...
                        >
                            ...
                            >
                                ...
                                <h2 className="text-4xl font-bold text-stone-100 mb-4">Time's Up!</h2>
                                ...
                                <div className="flex gap-4">
                                    <button
                                        onClick={startGame}
                                        className="flex-1 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-500 text-stone-100 font-bold rounded-xl hover:shadow-xl transition-all"
                                    >
                                        Play Again
                                    </button>
                                    <Link
                                        href="/student/games"
                                        className="flex-1 px-6 py-3 bg-stone-800 text-orange-600 font-bold rounded-xl hover:shadow-xl transition-all flex items-center justify-center gap-2"
                                    >
                                        Games Menu
                                    </Link>
                                </div>
