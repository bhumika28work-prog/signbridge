        ...
        <div className="max-w-5xl mx-auto p-6">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {currentLesson.signVideoUrl && (
                            <div className="mb-8">
                                <div className="aspect-video bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-amber-500/10 rounded-2xl flex items-center justify-center relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10 text-center">
                                        <div className="w-20 h-20 bg-stone-800 rounded-full flex items-center justify-center mb-4 mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300">
                                            <Play className="w-10 h-10 text-purple-600 ml-1" />
                                        </div>
                                        <p className="text-amber-400 font-medium">Sign Language Video</p>
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="prose max-w-none">
                            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 mb-6">
                                <p className="text-2xl text-stone-100 leading-relaxed font-medium">
                                    {currentLesson.content}
                                </p>
                            </div>

                            {/* Audio Pronunciation Button */}
                            <button className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-500 text-stone-100 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105">
                        ...
                        {currentIndex === lessons.length - 1 && (
                            <motion.div
                                ...
                                className="mt-8 p-6 bg-gradient-to-r from-green-50 to-yellow-50 rounded-2xl border-2 border-green-200"
                            >
            ...
            <div className="mt-8 flex justify-between items-center">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-stone-100 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 disabled:hover:scale-100"
                >
                    Next
