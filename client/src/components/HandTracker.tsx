        ...
        <div className="space-y-6">
            ...
            {!webcamRunning && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-gradient-to-br from-cyan-50 to-cyan-50 rounded-2xl p-6 border-2 border-cyan-200"
                >
                    <h4 className="font-bold text-cyan-900 mb-3">📋 How to Use Sign Recognition</h4>
